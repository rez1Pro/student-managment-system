<div class="content" > 
<h1 class = "text-primary" > <i class = "fas fa-user-plus" ></i> Add Users <small>Statistics Overview </small> </h1>
						...
						if(count($input_error)===0){
							...
							if( mysqli_num_rows($check_username)===0){
								...
								if($runquery==true){
									...
									echo "<font color='green' size='20px' >You are successfully added a new user</font>";
	...
	<div class="row">
	  <div class= "col-md-12" >
	    <form action="" method="POST" enctype="multipart/form-data" class ="form-horizontal animate__animated animate__pulse " >
		  ...
		  <div class="form-group">
	  	    <div class= "col-md-4">
	  	       <input type="submit" class="btn btn-primary col-sm-6 mystyle" name="registration" value= "Add User"/>
	  	    </div>
	  	  </div>
	    </form>
	  </div>
