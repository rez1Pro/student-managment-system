...
<?php require_once("connect.php"); require_once("header.php");?>
<div class="content" > 
...
<form action="" enctype="multipart/form-data" method="POST">
  <div class="col-sm-9 col-md-9">
	...
	<input type="text" name = "gpa" class="form-control" id="gpa" placeholder= "GPA : Out of 5" pattern = "[0-5]" required = "required"  />
	</div>
	<div class="form-group">
